...
Para activar proyectos de Commerce Intelligence para Cloud Starter, cree una cuenta de Commerce Intelligence, cree una clave SSH y, finalmente, conéctese a la base de datos de Adobe Commerce.

Siga estos pasos:

1. Cree su cuenta de Adobe Commerce Intelligence:

   * Ir a [accounts.magento.com/customer/account/login](https://account.magento.com/customer/account/login).
   ...
   * Después de crear la cuenta, tendrá la opción de agregar usuarios a la nueva cuenta. Ahora se pueden añadir administradores técnicos para llevar a cabo los siguientes pasos.
   ...
   ![Adición de usuarios](/help/troubleshooting/miscellaneous/assets/add_users_mbi.png)

1. Introduce información sobre tu tienda para establecer tus preferencias.

   ![Añadir información de la tienda](/help/troubleshooting/miscellaneous/assets/add_store_info_mbi.png)

   Debe recopilar cierta información antes de poder conectar la base de datos para el tercer paso del flujo de incorporación. Va a rellenar el *[!UICONTROL Connect your database]* página en el paso 9.

1. Cree un usuario de Commerce Intelligence dedicado.

   * Crear un nuevo usuario el [account.adobe.com](https://account.adobe.com/).
   * Ir a [https://accounts.magento.com/customer/account/](https://accounts.magento.com/customer/account/) para generar su cuenta de Adobe Commerce.
...
1. Obtenga sus claves SSH de Commerce Intelligence.
   ...
   * Vaya a la **[!UICONTROL Connect your database]** de la interfaz de usuario de configuración de Commerce Intelligence y desplácese hacia abajo hasta **[!UICONTROL Encryption settings]**.
...
1. Añada la nueva clave pública de Magento BI Essentials al usuario de Commerce Intelligence creado en el paso 5.
   ...
   * Ir a [accounts.magento.com/customer/account/login](https://account.magento.com/customer/account/login). Inicie sesión con la información de inicio de sesión de la cuenta para el nuevo usuario de Commerce Intelligence creado. A continuación, vaya a **[!UICONTROL Account Settings]** pestaña.
   * Desplácese hacia abajo por la página y expanda la lista desplegable para claves SSH. Luego haga clic en **[!UICONTROL Add a public key]**.
   ...
   ![Añadir una clave pública](/help/troubleshooting/miscellaneous/assets/add_public_key_mbi.png)
...
1. Obtenga información para conectar su base de datos a Commerce Intelligence.

   Ejecutar `echo $MAGENTO_CLOUD_RELATIONSHIPS | base64 --decode | json_pp` para obtener información sobre cómo conectar la base de datos.
...
1. Conecte la base de datos de Adobe Commerce.
   ...
   ![Conectar la base de datos de Adobe Commerce](/help/troubleshooting/miscellaneous/assets/connect_magento_database_mbi.png)

   *Entradas*:

   * Nombre de integración: [Elija un nombre para la integración.]
   * Host: `mbi.internal`
   * Puerto: 3306
   * Nombre de usuario: mbi
   * Contraseña: [contraseña de entrada proporcionada en la salida del paso 8.]
   * Nombre de base de datos: main
   * Prefijos de tabla: [dejar en blanco si no hay prefijos de tabla]

1. Configure su [!UICONTROL Timezone Settings].
...
1. Obtenga información para la configuración de cifrado.
   ...
   * La IU del proyecto proporciona una cadena de acceso SSH. Esta cadena se puede utilizar para recopilar la información necesaria para la dirección remota y el nombre de usuario al configurar su **[!UICONTROL Encryption settings]**. Seleccionar **[!UICONTROL SSH]** para ver su nombre de usuario y dirección remota. La cadena de texto antes de *@* es su nombre de usuario y la cadena de texto después de *@* es su dirección remota.

   ![Acceso al sitio principal](/help/troubleshooting/miscellaneous/assets/access_site_mbi.png)

1. Introduzca información para su [!UICONTROL Encryption Settings].
