...
1. Confirme que [[!UICONTROL indexers]](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/cli/manage-indexers) (en nuestra documentación para desarrolladores) se están ejecutando y que `Product Feed` [!UICONTROL indexer] está establecido en `Update by Schedule`.
...
* [Desarrollo del administrador de recomendaciones de productos](https://experienceleague.adobe.com/en/docs/commerce-merchant-services/product-recommendations/developer/development-overview) en nuestra documentación para desarrolladores
...
* [Crear recomendaciones de productos](https://experienceleague.adobe.com/en/docs/commerce-merchant-services/product-recommendations/admin/create) en la Guía de recomendaciones de productos
* [Revisar registros y solucionar problemas](https://experienceleague.adobe.com/en/docs/commerce/saas-data-export/logs-troubleshooting/troubleshooting-logging) en la Guía de exportación de datos de [!DNL SaaS]
