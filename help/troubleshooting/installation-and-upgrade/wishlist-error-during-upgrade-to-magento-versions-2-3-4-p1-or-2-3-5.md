...
* [Adobe Commerce local y Magento Open Source: actualice la aplicación y los módulos de Adobe Commerce](https://experienceleague.adobe.com/es/docs/commerce-operations/upgrade-guide/overview)
