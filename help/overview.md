...
<tr>
    <td>
    <a href="https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-25321">[!DNL Security Scan Tool] devuelve "Actualizaciones de seguridad de APSByy-xx disponibles" incluso si el parche ya se ha aplicado:</a> [!DNL Security Scan Tool] informa de que hay actualizaciones de seguridad de APSByy-xx disponibles para Adobe Commerce y Magento Open Source aunque ya haya aplicado el parche. Puede ignorar esta notificación.
    </td>
    <td>Nuevo artículo </td>
    <td>5 de diciembre de 2024</td>
  </tr>
