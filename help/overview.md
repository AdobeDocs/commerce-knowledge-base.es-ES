...
>[!NOTE]
>
>La guía de la Base de conocimiento de asistencia de Adobe Commerce se está reestructurando y su contenido se está trasladando a otras ubicaciones dentro de Adobe Experience League. Utilice la [página de búsqueda y los filtros de Experience League](https://experienceleague.adobe.com/en/search#) para encontrar la solución de problemas y el contenido relacionado con la asistencia de Adobe Commerce más recientes.
