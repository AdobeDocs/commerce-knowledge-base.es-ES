...
>[!NOTE]
>
>No puede volver a abrir un caso respondiendo a una notificación por correo electrónico desde una incidencia cerrada. Para reabrir el caso, asegúrate de que el propietario de la cuenta te haya dado [acceso compartido](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26164).
