...
description: Aplique el parche ACSD-56023 para corregir el problema de Adobe Commerce en el que el contenido del widget no se actualiza en la página de CMS
feature: CMS
...
El parche ACSD-56023 corrige el problema de que el contenido del widget no se actualiza en la página de CMS. Esta revisión está disponible cuando está instalado [[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.44. El ID del parche es ACSD-56023. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.7.
