...
description: El parche de MDVA-37115 soluciona el problema de mostrar el aviso innecesario *Solo 0 restante* en la página de productos configurables. Este parche está disponible cuando está instalada la [Quality Patches Tool (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.2. El ID del parche es MDVA-37115. Tenga en cuenta que el problema se solucionó en Adobe Commerce 2.4.3.
...
El parche MDVA-37115 resuelve el problema en el que las *Solo quedan 0* el aviso se muestra en la página de productos configurables. Este parche está disponible cuando la variable [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.2 está instalado. El ID del parche es MDVA-37115. Tenga en cuenta que el problema se solucionó en Adobe Commerce 2.4.3.
...
Un innecesario *Solo quedan 0* el aviso se muestra en la página de productos configurables.
...
No *Solo quedan 0* el aviso se muestra en la página del producto.

<u>Resultados reales</u>:

*Solo quedan 0* el aviso se muestra en la página del producto.
