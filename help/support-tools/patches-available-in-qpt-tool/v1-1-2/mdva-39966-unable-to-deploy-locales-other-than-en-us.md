...
El parche de MDVA-39966 resuelve el problema en el que el usuario no puede implementar configuraciones regionales que no sean en_US. Este parche está disponible cuando la variable [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.2 está instalado. El ID del parche es MDVA-39966. Tenga en cuenta que el problema se corrigió en la versión 2.4.1 de Adobe Commerce.
