...
El parche MDVA-39546 soluciona el problema por el que la fecha de inicio de la actualización de ensayo puede fijarse en una fecha anterior a la fecha actual. Este parche está disponible cuando la variable [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.12 está instalado. El ID del parche es MDVA-39546. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.5.
...
1. Editar la actualización desde **Contenido** > **Ensayo de contenido** > **Tablero** y actualice la fecha de inicio con una fecha anterior y guarde el cambio.
