...
El parche MDVA-43983 soluciona el problema de que los productos configurados como &quot;No visibles individualmente&quot; siguen apareciendo en los resultados de búsqueda avanzada del catálogo. Este parche está disponible cuando la variable [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.14 está instalado. El ID del parche es MDVA-43983. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.5.
...
1. Cree un atributo con **Tipo de entrada de catálogo del propietario de la tienda** as **Desplegable** o **Muestra visual** (por ejemplo, Color).
1. Establecer **Uso en la búsqueda** as **Sí** y **Visible en búsqueda avanzada** as **Sí**.
1. Añada algunas opciones de atributos.
1. Creación de productos con **Visibilidad** as **No visible individualmente**.
1. Asignar opciones de atributo de color.
1. Vaya a la **Búsqueda avanzada en catálogo** página de la tienda.
