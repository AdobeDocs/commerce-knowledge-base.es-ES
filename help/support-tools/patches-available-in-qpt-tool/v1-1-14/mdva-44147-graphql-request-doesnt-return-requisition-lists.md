...
1. Inicie sesión como cliente y agregue un producto a la [Lista de solicitudes](https://experienceleague.adobe.com/es/docs/commerce-admin/b2b/requisition-lists/requisition-lists).
