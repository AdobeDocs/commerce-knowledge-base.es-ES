...
El parche MDVA-34330 resuelve el problema en el que los pedidos no se filtran según la zona horaria de administración. Este parche está disponible cuando está instalada la [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.24. El ID del parche es MDVA-34330. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.3.
...
1. Vaya a **Tiendas** > Configuración > **Configuración** > **General** y establezca la **Zona horaria** en la *Hora estándar del Este (América/Nueva_York)*
1. Realice un nuevo pedido después de las 00:00 UTC
1. Vaya a **Ventas** > **Pedidos** y filtre por la fecha de hoy
