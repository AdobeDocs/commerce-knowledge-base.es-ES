...
El parche MDVA-40311 corrige el problema en el que el usuario administrador recibe un mensaje de error: *Seguridad o clave de formulario no válidas. Actualice la página*, después de iniciar sesión en Admin, si la ruta de administración personalizada está configurada y la clave secreta está habilitada. Este parche está disponible cuando la variable [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.7 está instalado. El ID del parche es MDVA-40311. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.4.
...
El usuario administrador recibe un mensaje de error: *Seguridad o clave de formulario no válidas. Actualice la página*, después de iniciar sesión en Admin, si la ruta de administración personalizada está configurada y la clave secreta está habilitada.
...
*Seguridad o clave de formulario no válidas. Actualice la página* se muestra un mensaje de error.
