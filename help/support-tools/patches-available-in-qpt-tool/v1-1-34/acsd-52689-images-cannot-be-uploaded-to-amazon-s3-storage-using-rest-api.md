...
El parche ACSD-52689 soluciona el problema de que las imágenes no se pueden cargar en el almacenamiento de Amazon S3 mediante la API de REST. Este parche está disponible cuando la variable [!DNL Quality Patches Tool (QPT)] 1.1.34 está instalado. El ID del parche es ACSD-52689. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.7.
