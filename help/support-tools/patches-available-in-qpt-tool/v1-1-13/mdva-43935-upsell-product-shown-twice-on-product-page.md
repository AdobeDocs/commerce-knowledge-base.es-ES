...
El parche MDVA-43935 soluciona el problema de que el producto de ampliación de venta se muestra dos veces en la página del producto. Este parche está disponible cuando la variable [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.13 está instalado. El ID del parche es MDVA-43935. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.5.
