...
El parche de MDVA-42237 soluciona el problema de que el precio especial del producto configurable no se actualiza después de cambios en el precio del subproducto. Este parche está disponible cuando la variable [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.11 está instalado. El ID del parche es MDVA-42237. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.5.
...
1. Ir a **Administrador** > **Sistema** > **Administración de índices** y establecer **Modo de índice** hasta **Actualizar según lo programado** para todos los índices.
