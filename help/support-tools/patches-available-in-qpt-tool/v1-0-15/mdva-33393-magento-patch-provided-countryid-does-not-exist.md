...
El parche MDVA-33393 resuelve el problema donde aparece el mensaje de error: *El countryId proporcionado no existe.* se muestra en el registro de excepciones.
