...
**El parche se ha creado para la versión de Adobe Commerce:** Adobe Commerce en la infraestructura en la nube 2.3.6
...
1. Cree un producto configurable con una opción (Ejemplo: **color** = *rojo*) y establezca **qty** = *1*.
1. Cree un cliente y haga un pedido con este producto, que en ese momento será **qty** = *0*.
1. Vaya a Administración e intente reordenar el pedido anterior.

<u>Resultados esperados</u>:

El cliente recibe el &quot;*Este producto está agotado.*&quot; para un producto agotado, tal como se esperaba.

<u>Resultados reales</u>:

El cliente recibe el &quot;*Este producto está agotado.*&quot;, y `var/log/exception.log` contiene una excepción similar:
