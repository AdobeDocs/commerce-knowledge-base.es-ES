...
El parche MDVA-20376 resuelve el problema de una *No existe esa entidad con customerId = 1* error para clientes que iniciaron sesión después de realizar el pedido. Este parche está disponible cuando la variable [Herramienta Parches de calidad (QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) 1.0.13 está instalado. Tenga en cuenta que el problema se corrigió en la versión 2.3.4 de Adobe Commerce.
...
Los clientes que iniciaron sesión reciben *No existe esa entidad con customerId = 1* error tras la colocación del pedido.

<u>Pasos a seguir</u>:

1. Vaya a la tienda e inicie sesión como usuario registrado.
1. Haga un pedido.
1. En la CLI, vaya a `var/log` y verá el... `exception.log` archivo.
