...
El parche de MDVA-19640 soluciona el problema cuando los informes avanzados no muestran datos. Este parche está disponible cuando está instalada la [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.20. El ID del parche es MDVA-19640. Tenga en cuenta que no hay ningún plan actual para solucionar este problema en versiones futuras.
...
1. Ver la página **Informes avanzados**.
...
<u>Pasos adicionales requeridos después de la instalación del parche</u>:
