...
El parche MDVA-38526 resuelve el problema en el que el usuario administrador no puede acceder a la herramienta SWAT. Este parche está disponible cuando la variable [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.9 está instalado. El ID del parche es MDVA-38526. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.4.
...
Intente alcanzar la `../swat/key/index`
...
500 El error se activa con el siguiente registro de errores: *No se puede anular la serialización del valor. Error: error de sintaxis*.
