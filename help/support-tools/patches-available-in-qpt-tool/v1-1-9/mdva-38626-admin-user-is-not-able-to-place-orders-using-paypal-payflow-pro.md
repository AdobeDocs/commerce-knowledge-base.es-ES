...
El parche MDVA-38626 resuelve el problema en el que el usuario administrador no puede realizar un pedido en el backend mediante el método de pago PayPal Payflow Pro. Este parche está disponible cuando la variable [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.9 está instalado. El ID del parche es MDVA-38626. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.5.
...
1. Ir a **Clientes** > **Todos los clientes** y cree una cuenta de cliente.
1. Haga clic en **Crear pedido**.
