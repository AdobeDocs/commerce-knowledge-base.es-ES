...
El parche MDVA-35984 soluciona el problema que se produce al crear varios envíos simultáneos para el mismo producto y que proporciona una cantidad de producto (cantidad) incorrecta. Este parche está disponible cuando la variable [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.21 está instalado. El ID del parche es MDVA-35984. Tenga en cuenta que el problema se solucionó en Adobe Commerce 2.4.3.
...
1. Cree un producto sencillo con **Cant** = *100*.
...
El resultado es el producto **Cant** = *98* después de ambos envíos.

<u>Resultados reales</u>:

El resultado es el producto **Cant** = *99* después de ambos envíos.
