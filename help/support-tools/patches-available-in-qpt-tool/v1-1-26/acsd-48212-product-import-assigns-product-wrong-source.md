...
El parche ACSD-48212 corrige el problema en el que la importación del producto asigna el producto al origen incorrecto. Este parche está disponible cuando la variable [[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.26 está instalado. El ID del parche es ACSD-48212. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.7.
...
1. Abrir **[!UICONTROL Catalog]** > **[!UICONTROL Prdoucts]**.
1. Seleccione el producto en la cuadrícula.
1. Cancele la asignación de las existencias utilizando *[!UICONTROL mass action]* menú.
1. Ejecutar `bin/magento cron:run`.
1. Asigne el origen secundario mediante el *[!UICONTROL mass action]* menú.
1. Ejecutar `bin/magento cron:run`.
1. Elimine el producto mediante la variable *[!UICONTROL mass action]* menú.
1. Ejecutar `bin/magento cron:run`.
