...
El parche ACSD-48773 soluciona el problema de que la plantilla de correo electrónico de puntos de recompensa se toma de la tienda incorrecta. Este parche está disponible cuando la variable [[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.26 está instalado. El ID del parche es ACSD-48773. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.7.
...
1. Ir a **[!UICONTROL Stores]** > **[!UICONTROL Configuration]** > **[!UICONTROL Catalog]** > **[!UICONTROL Product Reviews]** y habilitar **[!UICONTROL Reviews]**.
1. Ir a **[!UICONTROL Stores]** > **[!UICONTROL Configuration]** > **[!UICONTROL Store Email Addresses]**.
Cambie a la **[!DNL default website scope]** y configure el **[!UICONTROL Customer Support Sender Email]** dirección, (por ejemplo: *support_base@example.com*).
Cambie a la **[!DNL second website scope]** y configure el **[!UICONTROL Customer Support Sender Email]** Dirección a otro valor (por ejemplo: *support_second@example.com*).
1. Ir a **[!UICONTROL Stores]** > **[!UICONTROL Configuration]** > **[!UICONTROL Customers]** > **[!UICONTROL Customer Configuration]** > **[!UICONTROL Account Sharing Options]** > **[!UICONTROL Share Customer Accounts]** y establezca **[!UICONTROL Share Customer Accounts]** = *Por sitio web*.
...
1. Ir a **[!UICONTROL Stores]** > **[!UICONTROL Other Settings]** > **[!UICONTROL Reward Exchange Rates]** y establezca los tipos de cambio del segundo sitio web para ambos **[!UICONTROL Points/Currency]** y **[!UICONTROL Currency/Points]**.
...
1. Ir a **[!UICONTROL Marketing]** > **[!UICONTROL User Content]** > **[!UICONTROL Pending Reviews]**.
1. Cambie el estado de la nueva revisión a ***[!UICONTROL Approved]*** y **[!UICONTROL Save]**.
