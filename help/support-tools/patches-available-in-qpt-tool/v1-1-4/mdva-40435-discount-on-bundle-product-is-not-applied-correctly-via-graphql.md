...
El parche MDVA-40435 soluciona el problema de que el descuento en un producto empaquetado no se aplique correctamente a través de GraphQL. Este parche está disponible cuando la variable [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.4 está instalado. El ID del parche es MDVA-40435. Tenga en cuenta que el problema está programado para solucionarse en Adobe Commerce 2.4.4.
