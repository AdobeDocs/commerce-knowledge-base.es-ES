...
El parche MDVA-35847 soluciona el problema de que el formulario de usuario de la empresa no funciona y devuelve un error 500 en el front-end. Este parche está disponible cuando está instalada la [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.19. El ID del parche es MDVA-35847. Tenga en cuenta que el problema se corrigió en la versión 2.4.3 de Adobe Commerce.
...
1. Vaya a **Tiendas** > **Atributos** > **Cliente** y cree un nuevo atributo de cliente personalizado:

   * Tipo de entrada = *Fecha*
   * Mostrar en tienda = *Sí*
   * Orden = *0*
   * Forms que usar en = *Todos los formularios*
