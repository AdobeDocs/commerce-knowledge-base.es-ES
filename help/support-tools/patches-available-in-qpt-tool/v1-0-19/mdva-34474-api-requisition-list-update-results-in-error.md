...
El parche MDVA-34474 corrige el problema en el que, al añadir un producto a la lista de solicitudes mediante API, se produce un error. Este parche está disponible cuando está instalada la [Herramienta Parches de calidad (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.19. El ID del parche es MDVA-34474. Tenga en cuenta que el problema se solucionó en Adobe Commerce 2.4.3.
...
1. Activar lista de solicitudes en Administración (**Tiendas** > **Configuración** > **General** > **Características B2B** > **Activar lista de solicitudes** = *Sí*).
1. Crear un cliente.
1. Cree una nueva lista de solicitudes para esta llamada de envío de cliente ```json    POST rest/all/V1/requisition_lists``` con la carga útil json adjunta.
