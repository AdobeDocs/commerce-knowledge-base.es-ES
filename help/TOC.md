...
* Resolución de problemas {#troubleshooting}
   ...
   * Instalación y actualización {#installation-and-upgrade}
      ...
      * [Error de no se ha establecido el código de área al ejecutar el programa de instalación :upgrade](/help/troubleshooting/installation-and-upgrade/area-code-is-not-set-error-when-running-setup-upgrade.md)
   ...
   * Implementación {#deployment}
      ...
      * [El parche no encontró errores durante la implementación o la aplicación manual](/help/troubleshooting/deployment/deployment-errors-where-patches-not-found.md)
